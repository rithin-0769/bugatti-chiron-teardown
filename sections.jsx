...
export function HeroSection() {
  ...
  return (
    <section ref={secRef} style={S.heroScroll}>
...
const FEATURES = [
  ...
  },
  {
    ...
    text: "Massive carbon-ceramic brakes paired with eight-piston calipers in the front. Capable of arresting immense mass from hypersonic speeds.",
  },
  {
    frameNum: 160,
    label: "Engineering",
...
export function FeaturesSection() {
  ...
  return (
    <section ref={secRef} style={S.features}>
      <p style={{
        ...S.featHeading,
        opacity:   vis ? 1 : 0,
...
export function CTASection() {
  ...
  return (
    <section ref={secRef} style={S.ctaInfo}>
      <div style={{
        ...S.ctaInfoBlock,
        opacity:   vis ? 1 : 0,
...
export function FooterSection() {
  return (
    <footer style={S.footer}>
      <p style={S.footerText}>© Bugatti Concept</p>
    </footer>
  );
}
